...
AuraGroove — это самообучающаяся музыкальная экосистема. Она использует принципы генетических алгоритмов для повышения качества музыки.
...
*   **Genetic Memory**: Семена успешных сессий сохраняются в облачный генофонд (`masterpieces`).
*   **Breeding (Crossover)**: Новые пьесы могут наследовать черты «предков». Механизм `crossoverDNA` смешивает текущее семя с успешным семенем из прошлого, передавая удачные гармонические и ритмические паттерны следующим поколениям.
