# DNA Rules: The Heritage Codex (v1.0)
...
13. **Session Uniqueness**: The first donor track and the sequence of tracks must be unique for every launch. Use a "Blacklist" history of 5-7 tracks to prevent repeats.
