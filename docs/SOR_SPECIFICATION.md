...
# Техническая Спецификация: СОР (Система Обеспечения Разнообразия) v2.11
...
### 2.5. Organic Detail Layer (Протокол Резонанса)
*   **Механика**: Использование всех 15 слоев перкуссии (`perc-001` - `perc-015`) и ПВХ-труб в качестве тактильного фона.
*   **Логика**: Плотность и активность органического слоя напрямую зависит от уровня `Fog` (Туман). Звуки «прощупывают» атмосферу, создавая эффект осязаемого пространства.
