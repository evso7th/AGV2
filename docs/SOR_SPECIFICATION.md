...
# Техническая Спецификация: СОР (Система Обеспечения Разнообразия) v2.2
...
4.  **Регистровый потолок**: MIDI 79 (G5) для гитары.

---
**Статус**: Документация синхронизирована с Планом №266. Система стабильна.
