...
/**
 * @fileOverview Liquid Nebula V2.0 — "Absolute Reference".
 * #ЗАЧЕМ: Реализация ПЛАНА №1475. Полный перенос структуры из YaMus2.html.
 */
export function LiquidNebula({ genre, tension, className, isReference = false }: LiquidNebulaProps) {
    
    const colors = useMemo(() => {
        if (isReference) return {} as React.CSSProperties;
