...
**ЦЕЛЬ ОТКАТА:**
Устранить все накопившиеся экспериментальные изменения и начать работу с "золотого стандарта", который является общей точкой правды для проекта. Это позволит применить накопленный опыт для построения более надежной архитектуры с нуля.
