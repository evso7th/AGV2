...
**ДЕЙСТВИЕ:**
Выполнен откат кодовой базы к версии `86c66ca`.

**ПРИЧИНА:**
Модификация переходной секции "Променад", заменявшая "sparkles" на новые SFX, отменена для пересмотра подхода.

**ЦЕЛЬ ОТКАТА:**
Вернуться к стабильному состоянию до изменения логики "Променада".
