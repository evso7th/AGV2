...
**ЦЕЛЬ ОТКАТА:**
Вернуться к последней стабильной точке, когда все жанры работали корректно, а блюзовый бас генерировался по старой, хоть и примитивной, но рабочей схеме. Это позволит нам начать реализацию библиотеки блюзовых риффов заново, но уже с учетом допущенных ошибок и с повышенной осторожностью, следуя принципу "семь раз отмерь - один раз отрежь".
