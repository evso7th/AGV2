 ...
 * #ОБНОВЛЕНО (ПЛАН №530): Удалены все лики короче 4-х тактов. Внедрен жесткий стандарт 48 тиков.
 */
...
export const BLUES_SOLO_LICKS: Record<string, { phrase: BluesSoloPhrase; tags: string[] }> = {
  // --- NARRATIVE SENTENCES (EXACTLY 4 BARS / 48 TICKS) ---
