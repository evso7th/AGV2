 ...
 * #ЧТО: Экспортирует BLUES_SOLO_LICKS (25 ликов) и BLUES_SOLO_PLANS.
...
export const BLUES_SOLO_LICKS: Record<string, { phrase: BluesSoloPhrase; tags: string[] }> = {
  ...
  // --- HIGH DENSITY LICKS FOR PLAN 94 ---
  L22_ACTIVE: {
...
export const BLUES_SOLO_PLANS: Record<string, { choruses: string[][] }> = {
  ...
  "S04": { // Smoother for Winter Blues
    choruses: [
      ['L06', 'L11', 'L04', 'L06', 'L11', 'L04', 'L03', 'L10', 'L06', 'L11', 'L02', 'L09'],
      ['L08', 'L11', 'L04', 'L01', 'L11', 'L04', 'L03', 'L10', 'L12', 'L12', 'L01', 'L19'],
      ['L10', 'L11', 'L04', 'L06', 'L11', 'L04', 'L03', 'L10', 'L06', 'L11', 'L02', 'L09']
    ]
  },
  "S06": { // Dark/Minor
    choruses: [
