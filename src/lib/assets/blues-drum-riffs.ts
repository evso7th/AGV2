...
export const BLUES_DRUM_RIFFS: BluesDrumRiffs = {
  ...
  contemplative: [ // Mapped from Neutral
    ...
    { K: [0, 6], SD: [3, 9], HH: [0, 2, 3, 5, 6, 8, 9, 11], R: [3, 6, 9] },
  ],
  dreamy: [
  ...
  melancholic: [
    ...
    { K: [0], SD: [3, 9], HH: [0, 2, 3, 5, 6, 8, 9, 11], ghostSD: [2, 5, 8, 11], T: [11] },
  ...
  gloomy: [
    ...
    { K: [0, 8], SD: [3, 9], HH: [0, 2, 3, 5, 6, 8, 9, 11] },
    { K: [0, 6], SD: [3, 9], HH: [0, 2, 3, 5, 6, 8, 9, 11] },
  ],
  dark: [
    { K: [0, 6, 8], SD: [3, 9], HH: [0, 2, 3, 5, 6, 8, 9, 11] },
    ...
    { K: [0, 6, 8], SD: [3, 9], HH: [0, 2, 3, 5, 6, 8, 9, 11] },
    { K: [0, 8], SD: [9], HH: [0, 2, 3, 5, 6, 8, 9, 11], ghostSD: [2, 5, 8, 11] },
  ],
  epic: [],
  anxious: [],
};
