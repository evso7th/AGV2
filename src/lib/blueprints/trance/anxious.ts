...
export const AnxiousTranceBlueprint: MusicBlueprint = {
    ...
    structure: {
        ...
        parts: [
            {
                id: 'INTRO_1', name: 'Signal Lost', duration: { percent: 15 }, // УВЕЛИЧЕНО
                ...
                instrumentRules: { 
                    ...
                    drums: { pattern: 'composer', density: {min: 0.7, max: 0.9}, useSnare: false, kickVolume: 0.8, usePerc: true, alternatePerc: true }, // СМЯГЧЕНО
            ...
            {
                id: 'INTRO_2', name: 'Glitching Beat', duration: { percent: 15 }, // УВЕЛИЧЕНО
                ...
                instrumentRules: { 
                    drums: { pattern: 'composer', density: { min: 0.6, max: 0.8 }, useSnare: true, kickVolume: 0.9, usePerc: true, alternatePerc: true, rareKick: true }, // СМЯГЧЕНО
                    melody: { source: 'harmony_top_note' }
                },
            ...
            {
                id: 'BUILD', name: 'System Alert', duration: { percent: 20 }, // УМЕНЬШЕНО
                ...
                instrumentRules: { 
                    drums: { pattern: 'composer', density: { min: 0.8, max: 1.0 }, useSnare: true, usePerc: true, kickVolume: 1.1 }, // СМЯГЧЕНО
            ...
            {
                id: 'PEAK', name: 'Red Alert', duration: { percent: 30 }, // УМЕНЬШЕНО
                ...
                instrumentRules: { 
                    drums: { pattern: 'composer', density: { min: 0.9, max: 1.0 }, useSnare: true, usePerc: true, alternatePerc: true, kickVolume: 1.3 }, // СМЯГЧЕНО
                    melody: { source: 'harmony_top_note' }
                },
            ...
            {
                id: 'OUTRO', name: 'Corruption', duration: { percent: 20 }, // УВЕЛИЧЕНО
                layers: { sfx: true, drums: true, accompaniment: true },
                instrumentation: { accompaniment: { strategy: 'weighted', v1Options: [{ name: 'synth', weight: 1.0 }], v2Options: [{ name: 'synth', weight: 1.0 }] } },
                instrumentRules: { 
