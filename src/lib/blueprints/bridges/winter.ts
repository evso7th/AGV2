...
/**
 * #ЗАЧЕМ: Mood-specific Winter Bridge (The Frozen Path).
 * #ЧТО: Короткий (4 такта) меланхоличный переход. Орган и шепот ветра.
 */
export const WinterBridgeBlueprint: MusicBlueprint = {
    id: 'winter_bridge',
    name: 'Frost Transition',
    description: 'A melancholic winter bridge with soft organ and wind textures.',
    mood: 'melancholic',
    musical: {
        ...
        parts: [
            {
                ...
                stagedInstrumentation: [
                    { 
                        ...
                        instrumentation: {
                           ...
                           sfx: { activationChance: 0.9, instrumentOptions: [ { name: 'common', weight: 1.0 } ], transient: true }
                        }
                    }
                ],
                instrumentRules: {
                ...
                bundles: [{ id: 'WINTER_BRIDGE_B1', name: 'Frozen Path', duration: { percent: 100 }, characteristics: {}, phrases: {} }],
                outroFill: null,
            }
        ]
    },
