...
export const DarkBluesBlueprint: MusicBlueprint = {
    ...
    structure: {
        ...
        parts: [
            ...
            {
                id: 'INTRO_2', name: 'Bass Drone', duration: { percent: 3 }, // ~4 bars
                layers: { drums: true, bass: true, accompaniment: true, sfx: true },
                instrumentation: {
                    accompaniment: { strategy: 'weighted', v1Options: [{ name: 'organ_soft_jazz', weight: 1.0 }], v2Options: [{ name: 'organ_soft_jazz', weight: 1.0 }] },
                    bass: { strategy: 'weighted', v1Options: [{ name: 'ambientDrone', weight: 1.0 }], v2Options: [{ name: 'bass_ambient_dark', weight: 1.0 }] }
                },
                instrumentRules: {
                    drums: { density: { min: 0.15, max: 0.25 } },
                    bass: { techniques: [{ value: 'drone', weight: 1.0 }] },
                    melody: { source: 'harmony_top_note' }
                },
                bundles: [{ id: 'DARK_INTRO_2_BUNDLE', name: 'Drone Entry', duration: { percent: 100 }, characteristics: {}, phrases: {} }],
                outroFill: null,
            },
            {
                id: 'INTRO_3', name: 'Ghost Guitar', duration: { percent: 4 }, // ~4 bars
                ...
                instrumentRules: {
                    drums: { density: { min: 0.2, max: 0.3 } },
                    melody: { source: 'motif', density: { min: 0.1, max: 0.2 }, presetModifiers: { reverbMix: 0.7, delay: { on: true, time: 0.6, fb: 0.5, hc: 1800, mix: 0.4 } } }
                },
                bundles: [{ id: 'DARK_INTRO_3_BUNDLE', name: 'First Motif', duration: { percent: 100 }, characteristics: {}, phrases: {} }],
                outroFill: { type: 'roll', duration: 1, parameters: { instrument: 'tom_low', density: 0.5 } },
            },
            // --- MAIN (96 bars total) ---
            {
                id: 'MAIN_1', name: 'The Chant', duration: { percent: 27 }, // ~32 bars
                layers: { bass: true, drums: true, accompaniment: true, melody: true, sfx: true },
                instrumentation: {
                    melody: { strategy: 'weighted', v1Options: [{ name: 'blackAcoustic', weight: 1.0 }], v2Options: [{ name: 'blackAcoustic', weight: 1.0 }] }
                },
                instrumentRules: {
            ...
            {
                id: 'MAIN_2', name: 'Ritual Peak', duration: { percent: 27 }, // ~32 bars
                layers: { bass: true, drums: true, accompaniment: true, melody: true, sfx: true },
                instrumentation: {
                    melody: { strategy: 'weighted', v1Options: [{ name: 'blackAcoustic', weight: 1.0 }], v2Options: [{ name: 'blackAcoustic', weight: 1.0 }] }
                },
                instrumentRules: {
                    ...
                    melody: { density: { min: 0.4, max: 0.6 }, soloPlan: 'S07' }
                },
            ...
            {
                id: 'MAIN_3', name: 'Waning Chant', duration: { percent: 26 }, // ~32 bars
                layers: { bass: true, drums: true, accompaniment: true, melody: true, sfx: true },
                 instrumentation: {
                    melody: { strategy: 'weighted', v1Options: [{ name: 'blackAcoustic', weight: 1.0 }], v2Options: [{ name: 'blackAcoustic', weight: 1.0 }] }
                },
                instrumentRules: {
                    ...
                    melody: { density: { min: 0.3, max: 0.5 }, soloPlan: 'S08' }
                },
            ...
            // --- OUTRO (12 bars total) ---
            {
                id: 'OUTRO_1', name: 'Fading Embers', duration: { percent: 3 }, // ~4 bars
            ...
            {
                id: 'OUTRO_2', name: 'Cold Ash', duration: { percent: 3 }, // ~4 bars
            ...
            {
                id: 'OUTRO_3', name: 'Silence', duration: { percent: 4 }, // ~4 bars
                layers: { sfx: true },
                instrumentRules: {
