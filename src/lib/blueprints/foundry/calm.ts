...
/**
 * @fileOverview Foundry Calm Blueprint V1.0.
 * #ЗАЧЕМ: 100% клон Trance Calm для Foundry.
 */
export const CalmFoundryBlueprint: MusicBlueprint = {
    id: 'calm_foundry',
    name: 'Orbital Path (Foundry)',
    description: 'Steady industrial hypnotic clone.',
    mood: 'calm',
    musical: {
        ...
        harmonicJourney: [],
        tensionProfile: { type: 'plateau', peakPosition: 0.4, curve: (p, pp) => p < pp ? p / pp : (p < 0.8 ? 1.0 : 1 - ((p - 0.8) / 0.2)) }
    },
    structure: {
        ...
        parts: [
            {
                ...
                bundles: [{ id: 'FO_CALM_INTRO', name: 'Main', duration: { percent: 100 }, characteristics: {}, phrases: {} }],
                outroFill: null,
            },
            {
