...
export const STYLE_DRUM_PATTERNS: Record<Genre, DrumPatternEvent[]> = {
    ambient: [
        ...
        { type: ['drum_hihat_closed', 'perc-008'], probabilities: [0.7, 0.3], time: 1.5, duration: 0.5, weight: 0.3 },
        { type: 'drum_kick', time: 2, duration: 2, weight: 0.4, probability: 0.6 },
        { type: ['drum_hihat_open', 'perc-011'], probabilities: [0.7, 0.3], time: 3.5, duration: 0.5, weight: 0.3 },
        { type: 'drum_tom_low', time: 3.75, duration: 0.25, weight: 0.4, probability: 0.35 },
    ],
    rock: [
        ...
        { type: 'drum_crash', time: 0, duration: 1, weight: 0.7, probability: 0.25 },
    ...
    house: [
        ...
        { type: ['drum_hihat_closed', 'perc-003'], probabilities: [0.7, 0.3], time: 1.5, duration: 0.5, weight: 0.8 },
        { type: 'drum_snare', time: 2, duration: 0.25, weight: 0.9, probability: 0.9 },
        { type: ['drum_hihat_closed', 'drum_hihat_open'], probabilities: [0.5, 0.5], time: 2.5, duration: 0.5, weight: 0.8 },
        { type: 'drum_snare', time: 3, duration: 0.25, weight: 0.9 },
        { type: ['drum_hihat_closed', 'perc-007'], probabilities: [0.7, 0.3], time: 3.5, duration: 0.5, weight: 0.8 },
    ],
    trance: [
        { type: 'drum_kick', time: 0, duration: 0.25, weight: 1.0 },
        ...
        { type: 'perc-010', time: 0.75, duration: 0.25, weight: 0.4, probability: 0.4 },
        { type: 'perc-012', time: 2.75, duration: 0.25, weight: 0.4, probability: 0.4 },
    ],
    rnb: [
        { type: 'drum_kick', time: 0, duration: 0.25, weight: 1.0 },
        { type: 'drum_snare', time: 1, duration: 0.25, weight: 0.9 },
        ...
        { type: ['drum_hihat_closed', 'perc-001'], probabilities: [0.5, 0.5], time: 0.5, duration: 0.25, weight: 0.5 },
        { type: 'perc-004', time: 2.25, duration: 0.25, weight: 0.4, probability: 0.5 },
        { type: 'drum_hihat_closed', time: 2.5, duration: 0.25, weight: 0.5, probability: 0.7 },
    ],
    ballad: [
        ...
        { type: ['drum_ride', 'perc-013'], probabilities: [0.8, 0.2], time: 1, duration: 0.5, weight: 0.5},
        { type: ['drum_ride', 'drum_hihat_closed'], probabilities: [0.9, 0.1], time: 2, duration: 0.5, weight: 0.5},
        { type: ['drum_ride', 'perc-014'], probabilities: [0.8, 0.2], time: 3, duration: 0.5, weight: 0.5},
    ],
    reggae: [
        { type: 'drum_kick', time: 2.5, duration: 0.25, weight: 1.0 },
        { type: 'drum_snare', time: 1, duration: 0.25, weight: 0.9, technique: 'hit' },
        { type: ['drum_hihat_closed', 'perc-009'], probabilities: [0.6, 0.4], time: 0.5, duration: 0.25, weight: 0.8 },
    ...
    blues: [
        ...
        { type: 'drum_ride', time: 1.5, duration: 0.5, weight: 0.6, probability: 0.6},
        { type: 'perc-002', time: 3.75, duration: 0.25, weight: 0.3, probability: 0.4},
    ],
    celtic: [
        { type: ['drum_tom_low', 'drum_kick'], probabilities: [0.8, 0.2], time: 0, duration: 0.5, weight: 1.0 },
        { type: 'drum_tom_high', time: 1, duration: 0.5, weight: 0.8 },
        { type: ['drum_tom_low', 'drum_kick'], probabilities: [0.8, 0.2], time: 2, duration: 0.5, weight: 1.0 },
        { type: 'drum_tom_high', time: 3, duration: 0.5, weight: 0.8 },
        { type: 'perc-015', time: 1.5, duration: 0.5, weight: 0.5, probability: 0.5},
        { type: 'perc-005', time: 3.5, duration: 0.5, weight: 0.5, probability: 0.5},
    ],
    progressive: [
        ...
        { type: 'perc-008', time: 1.75, duration: 0.25, weight: 0.4, probability: 0.4},
        { type: 'perc-011', time: 3.75, duration: 0.25, weight: 0.4, probability: 0.5},
    ],
    dark: [],
    dreamy: [],
    epic: [],
