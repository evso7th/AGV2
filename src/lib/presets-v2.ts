...
export const V2_PRESETS = {
  ...
  synth_cave_pad: {
    ...
    lpf: { cutoff: 600, q: 0.7, mode: '24dB' }, 
    chorus: { on: true, rate: 0.1, depth: 0.01, mix: 0.6 },
    delay: { on: true, time: 0.8, fb: 0.45, hc: 1200, mix: 0.35 },
    reverbMix: 0.5
  },
  ...
  ep_rhodes_warm: {
    ...
    lpf: { cutoff: 2100, q: 0.9, mode: '24dB' }, 
    chorus: { on: true, rate: 0.25, depth: 0.006, mix: 0.22 },
    delay: { on: true, time: 0.26, fb: 0.12, hc: 3000, mix: 0.10 },
    reverbMix: 0.18
  },
  ...
  guitar_shineOn: {
    ...
    delayA: { time: 0.45, fb: 0.2, hc: 3500, mix: 0 }, 
    reverbMix: 0 
  },
  ...
  guitar_muffLead: {
    ...
    adsr: { a: 0.022, d: 0.5, s: 0.8, r: 1.5 }, 
    chorus: { on: false, mix: 0 }, 
    delayA: { time: 0.45, fb: 0.2, hc: 3200, mix: 0 }, 
    reverbMix: 0 
  },
