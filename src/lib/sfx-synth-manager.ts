...
/**
 * #ЗАЧЕМ: Менеджер SFX V10.2 — "The Voice Horizon Expansion".
 * #ЧТО: ПЛАН №1290 — Подключение 44 новых голосовых ассетов (Pixabay/Robot/Demon).
 */
const SFX_SAMPLES: Record<string, string[]> = {
    ...
    voice: [
        // Pixabay Expansion (Robot, Demon, Mystic)
