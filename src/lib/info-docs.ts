...
<div class="prose-info text-[13px] leading-relaxed space-y-6">
  <div class="text-center space-y-2 border-b border-primary/20 pb-4">
    ...
    <p class="text-lg font-bold">AuraGroove V 0.4.12 (Infinite Take Orchestra)</p>
    <p class="text-[10px] font-black opacity-50 uppercase tracking-[0.2em]">Interface: v15.3 | Core: v3.7.0</p>
  </div>
  ...
  <section class="space-y-3">
    <h2 class="text-base font-black text-primary uppercase border-l-4 border-primary pl-3 py-1">2. Иммерсивный режим (HUD)</h2>
    ...
    <p class="text-muted-foreground italic text-[12px]">Чтобы выйти из режима HUD, просто коснитесь любой кнопки управления или нажмите «X» на пульте.</p>
  </section>

  <section class="space-y-3">
    <h2 class="text-base font-black text-primary uppercase border-l-4 border-primary pl-3 py-1">3. Настройка звука</h2>
  ...
  <section class="space-y-3 pb-6">
    <h2 class="text-base font-black text-primary uppercase border-l-4 border-primary pl-3 py-1">4. Конфиденциальность</h2>
...
<div class="prose-info text-[13px] leading-relaxed space-y-6">
  ...
  <p class="italic text-muted-foreground">Welcome to AuraGroove V3—an autonomous musical intelligence that simulates the dynamics of a live ensemble. This guide will help you understand the project's philosophy and master real-time music generation.</p>
  ...
  <section class="space-y-3">
    <h2 class="text-base font-black text-primary uppercase border-l-4 border-primary pl-3 py-1">2. Immersive Mode (HUD)</h2>
    ...
    <p class="text-muted-foreground italic text-[12px]">Simply interact with any control or press 'X' to return to the standard interface.</p>
  </section>

  <section class="space-y-3">
    <h2 class="text-base font-black text-primary uppercase border-l-4 border-primary pl-3 py-1">3. Sound Setup</h2>
  ...
  <section class="space-y-2 pb-6">
    <h2 class="text-base font-black text-primary uppercase border-l-4 border-primary pl-3 py-1">4. Privacy</h2>
