...
export const SYNTH_PRESETS: Record<string, SynthPreset> = {
  ...
  synth_ambient_pad_lush: { layers: [ { type: 'sawtooth', detune: -4, octave: 0, gain: 0.5 }, { type: 'sawtooth', detune: 4, octave: 0, gain: 0.5 }, { type: 'sine', detune: 0, octave: -1, gain: 0.7 } ], adsr: { attack: 1.2, decay: 2.0, sustain: 0.8, release: 4.0 }, filter: { type: 'lowpass', cutoff: 1400, q: 1.0 }, lfo: { shape: 'sine', rate: 0.15, amount: 500, target: 'filter' }, effects: { distortion: 0, chorus: { rate: 0.18, depth: 0.008, mix: 0.45 }, delay: { time: 0.55, feedback: 0.35, mix: 0.25 } } },
  synth_cave_pad: { layers: [ { type: 'sawtooth', detune: -6, octave: 0, gain: 0.4 }, { type: 'sawtooth', detune: 6, octave: 0, gain: 0.4 }, { type: 'sine', detune: 0, octave: -1, gain: 0.8 } ], adsr: { attack: 1.5, decay: 2.0, sustain: 0.8, release: 5.0 }, filter: { type: 'lowpass', cutoff: 1400, q: 1.1 }, lfo: { shape: 'sine', rate: 0.1, amount: 5, target: 'pitch' }, effects: { distortion: 0, chorus: { rate: 0.15, depth: 0.008, mix: 0.6 }, delay: { time: 0.52, feedback: 0.45, mix: 0.35 } } },
