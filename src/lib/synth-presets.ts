...
export const SYNTH_PRESETS: Record<Exclude<MelodyInstrument | BassInstrument, 'piano' | 'violin' | 'flute' | 'acousticGuitarSolo' | 'guitarChords' | 'none'>, SynthPreset> = {
  ...
  //ORGAN УЛУЧШЕНО: Более аутентичный орган с имитацией "клика" и регистров
  organ: {
    layers: [
 ...
 // Synth УЛУЧШЕНО: Классический аналоговый лид-синт
 synth: {
  layers: [
 ...
 // Melloton УЛУЧШЕНО: Имитация "плавающей" ленты
 mellotron: {
  layers: [
